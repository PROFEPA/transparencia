    ...
    async function loadData() {
      try {
        const [dictRes, metaRes] = await Promise.all([
          fetch('/data/data_dictionary.json'),
        ...
        <div className="card mb-8">
          ...
          <nav>
            <ul className="space-y-2 text-gob-green-600">
              <li>
                <a href="#fuentes" className="hover:underline">1. Fuentes de información</a>
              </li>
              <li>
                <a href="#proceso" className="hover:underline">2. Proceso de extracción</a>
              </li>
              <li>
                <a href="#diccionario" className="hover:underline">3. Diccionario de datos</a>
              </li>
              <li>
                <a href="#limitaciones" className="hover:underline">4. Limitaciones y consideraciones</a>
              </li>
              <li>
                <a href="#versiones" className="hover:underline">5. Control de versiones</a>
              </li>
            </ul>
          </nav>
        </div>
          ...
          {dictionary?.columnas ? (
            <div className="space-y-4">
              {dictionary.columnas.map((col, index) => (
                <div key={index} className="card border-l-4 border-gob-green-500">
